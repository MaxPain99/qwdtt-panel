...
Панель UI: вкладки Мониторинг / Клиенты / Логи / Настройки (подвкладки qWDTT и CSQTT). Кнопка «Обновить с GitHub» собирает оба бинаря и перезапускает `wdtt` + `qwdtt-panel`.
